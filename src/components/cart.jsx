    ...
    <div className="min-h-screen bg-white py-12 px-4 sm:px-6 lg:px-8 font-sans ">
      <div className="max-w-5xl mx-auto">
        ...
        {cartItems.length === 0 ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 min-h-screen relative ">
            {/* Cart Items */}
              ...
              >
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-gray-900">
                      ${((getTotalPrice() - calculateDiscount()) * 0.08).toFixed(2)}
                    </span>
                  </div>
                </div>
                ...
                <div className="border-t border-gray-200 pt-4 mb-6">
                  <div className="flex justify-between font-bold text-lg">
                    ...
                    <span className="text-gray-900">${calculateFinalTotal()}</span>
                  </div>
                </div>
                ...
                <div className="mb-6">
                  ...
                  {appliedPromo && (
                    <p className="text-green-600 text-sm mt-1">{appliedPromo.message}</p>
                  )}
                </div>
